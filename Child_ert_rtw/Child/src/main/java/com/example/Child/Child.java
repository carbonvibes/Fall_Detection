...
import com.example.Child.databinding.ActivityMainBinding;
...
public class Child extends AppCompatActivity implements OnFragmentInteractionListener , SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.Child.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
    ...
    private Child thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","Child"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("Child.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
public void audioFileReadTerminate(int idx) {
    ...
    private native int naMain(String[] argv, Child pThis);
