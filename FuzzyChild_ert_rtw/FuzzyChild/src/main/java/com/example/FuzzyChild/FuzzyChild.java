package com.example.FuzzyChild;
...
import com.example.FuzzyChild.databinding.ActivityMainBinding;
...
public class FuzzyChild extends AppCompatActivity implements OnFragmentInteractionListener , SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.FuzzyChild.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
    ...
    private FuzzyChild thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","FuzzyChild"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("FuzzyChild.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
public void audioFileReadTerminate(int idx) {
    ...
    private native int naMain(String[] argv, FuzzyChild pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("FuzzyChild");
    }
